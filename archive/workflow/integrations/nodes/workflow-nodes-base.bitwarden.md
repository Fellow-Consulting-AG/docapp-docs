...
!!! note "🔑 Credentials"
    You can find authentication information for this node [here](/workflow/integrations/credentials/bitward).
...
![A workflow with the Bitwarden node](/_images/integrations/nodes/bitwardworkflow.png)
...
1. First of all, you'll have to enter credentials for the Bitwarden node. You can find out how to do that [here](/workflow/integrations/credentials/bitward).
...
![Using the Bitwarden node to create a new group](/_images/integrations/nodes/bitwardbitwarden_node.png)
...
![Using the Bitwarden node to get all the members](/_images/integrations/nodes/bitwardbitwarden1_node.png)
...
![Using the Bitwarden node to update members in a group](/_images/integrations/nodes/bitwardbitwarden2_node.png)
...
![Using the Bitwarden node to get members in a group](/_images/integrations/nodes/bitwardbitwarden3_node.png)
