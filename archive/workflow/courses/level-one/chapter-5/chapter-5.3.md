...
To select this value, click on the wheel icon “Add Expression” on the right side of the Value 1 field.
    ...
    <figure><img src="assets/images/courses/level-one/chapter-two/If-node-expression-editor.png" alt="Expression Editor in the IF node" style="width:100%"><figcaption align = "center"><i>Expression Editor in the IF node</i></figcaption></figure>
...
<figure><img src="assets/images/courses/level-one/chapter-two/If-node.png" alt="IF node" style="width:100%"><figcaption align = "center"><i>IF node</i></figcaption></figure>
...
<figure><img src="assets/images/courses/level-one/chapter-two/Workflow-with-If-node.png" alt="Workflow with the IF node" style="width:100%"><figcaption align = "center"><i>Workflow with the IF node</i></figcaption></figure>
