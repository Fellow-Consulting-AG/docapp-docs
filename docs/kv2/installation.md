...
- You must have set up a working Batch Class or install Polydocs GmbH default Batch Class for Plugin usage if no Batch Class is set up in your Ephesoft System, yet. (Contact us to get the Polydocs GmbH default Batch Class)

### Installation

##### Step 1: Access your Infor OS and open IDM Capture in the menu on the top left.

![](/_images/doc2/Screenshot-2021-07-13-at-12.12.26.png)

##### Step 2: Open your Ephesoft Transact system

![](/_images/doc2/Bildschirmfoto-2021-07-02-um-12.46.59-1024x545.png)

##### Step 3: As an Admin please click into the Administrator section and select eg. "Batch Class Management". Open the menu bar on the left and click "System Configuration".

![](/_images/doc2/Bildschirmfoto-2021-07-02-um-12.48.56-1024x523.png)

##### Step 4: Open Workflow Management  
...
Read this [Article](/doc2/fellowkv2-plugin/how-to-restart-ephesoft-server/) for how to restart Transact
