...
1. Access the [Twitter Developer](https://developer.twitter.com/portal/projects-and-apps) portal.
...
5. After confirming your email, you are redirected to the [#Welcome to the Twitter Developer Platform](https://developer.twitter.com/portal/register/welcome) page. Enter a name for your Twitter application and click the **Get keys** button.
...
- [Application-only Authentication](https://developer.twitter.com/docs/authentication/oauth-2-0/application-only)
