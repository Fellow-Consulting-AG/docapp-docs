...
description: This is a step by step guide how to create a BOD mapping file. You will find all values and fields that would need an adjustment in DocBits (DOC²) and the BOD.
date: "2021-10-28"
tags:
  - DocBits (DOC²)
  - Export
...
The "LogicalID" must be set to the logical ID of the IMS connection point that was defined for the DocBits (DOC²) BOD export.
...
In the second block you can adjust the document type mapping. On the left side you have the document type of DocBits (DOC²) and on the right side the document type of the BOD.
...
In the third block you can adjust the field mapping. On the left side are the fields of DocBits (DOC²) and on the right side the field names of the BOD.
