...
![](/_images/docbits/Bildschirmfoto-2021-07-05-um-14.03.57-1024x520.png)
...
![](/_images/docbits/image-2-1024x524.png)
...
![](/_images/docbits/image-4-1024x589.png)

* * *

## If you have an invoice with 0 VAT amount, teach them as follows:

![](/_images/docbits/image-5.png)

1. Invoice Details: Add the total amount in the corresponding field Total Amount. Leave Total Net Amount and Total VAT Amount blank.

![](/_images/docbits/image-6-1024x485.png)
...
![](/_images/docbits/image-7-1024x485.png)
