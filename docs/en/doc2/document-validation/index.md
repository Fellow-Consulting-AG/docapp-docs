...
![Dashboard](/_images/doc2/Document Validation/1-Index/DOC2_dashboard_1.png)

2\. Click on the bar to open the document. In this case it doesn't matter if you click on the document name or the status.

![Document](/_images/doc2/Document Validation/1-Index/DOC2_invoice-details_2.png)
...
![Amount/Date](/_images/doc2/Document Validation/1-Index/DOC2_amount-and-date-format_3.png)
...
![Invoice Number](/_images/doc2/Document Validation/1-Index/DOC2_invoice-number_4.png)
...
![Fields](/_images/doc2/Document Validation/1-Index/DOC2_correct-fields_5.png)
...
![Field Training Confirmation](docs/en/_images/doc2/Document Validation/1-Index/DOC2_confirm_field_6.png)
...
![Confirmation](/_images/doc2/Document Validation/1-Index/DOC2_click-check_7.png)
...
![VAT Rate](/_images/doc2/Document Validation/1-Index/DOC2_vat-rate_8.png)

![Supplier](/_images/doc2/Document Validation/1-Index/DOC2_supplier-name_9.png)
...
![Save](/_images/doc2/Document Validation/1-Index/DOC2_save_10.png)

When you have saved the changes, the document remains in the Ready for Validation status.

![Ready for Validation Status](/_images/doc2/Document Validation/1-Index/DOC2_dashboard_11.png)
