...
<img class="screenshot-full" src="assets/images/insight2/datasource-reference/rest-api/rest-api.gif" alt="Insight² - Data source - REST API" height="420"/>
...
<img class="screenshot-full" src="assets/images/insight2/datasource-reference/rest-api/rest-api-values.gif" alt="Insight² - Data source - REST API" height="420"/>
